...
| `/converge` | Brownfield / drift reconciliation: find the spec↔tasks coverage gap (`hx doti converge`), assess each uncovered `FR`/`SC` against the codebase, and append the genuinely-unbuilt work as new tasks. |
