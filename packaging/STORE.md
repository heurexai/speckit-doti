...
MSIX version prefix (for example, `0.5.0` in an MSIX identity version of `0.5.0.0`); the Store
...
& "${env:ProgramFiles(x86)}\Windows Kits\10\bin\<sdk-version>\x64\makeappx.exe" pack /d $layout /p speckit-doti-0.5.0.msix /o
```
