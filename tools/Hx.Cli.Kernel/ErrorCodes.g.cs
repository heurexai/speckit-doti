...
public static class ErrorCodes
{
    ...
    [
        ...
        new("VAL0003", "validation", "VAL", 3, Severity.Error, ExitClass.Validation, "validation.tool-store-version-unavailable",
            "The pinned tool version is not present in the shared tool store.", "Run `doti tools update` to populate the store, or re-run the installer; the solution pins a version the store lacks."),
