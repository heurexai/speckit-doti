...
public static class DotiWorkflowRegistry
{
    ...
    [
        ...
        Stage(4, "arch-review", "doti-arch-review", "Arch-Review", "advisory-required",
            ["tasks"], [],
            "Run `/05-doti-tasks` to break the reviewed plan into executable tasks."),
        Stage(5, "tasks", "doti-tasks", "Tasks", "required",
            ["analyze"], [],
            "Run `/06-doti-analyze` for a cross-artifact consistency review."),
        Stage(6, "analyze", "doti-analyze", "Analyze", "required",
            ["implement"], [],
