---
name: doti-clarify
description: Clarify scaffold-dotnet requirements while preserving command availability boundaries.
compatibility:
  - claude
metadata:
  source: doti/core/templates/commands/doti-clarify.md
...
Next stage: Run `/doti-plan` to author the implementation plan.
