...
| Platform probe | `hx platform probe` | implemented |
| Hygiene changed | `hx hygiene scan --repo . --scope changed --source staged --json` | implemented; Gitleaks vendored win-x64 (other RIDs fail closed) |
| Sentrux verify | `hx sentrux verify --repo . --json` | implemented; vendored win-x64 |
